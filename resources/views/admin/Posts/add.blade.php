...
@endif
    <form method='POST' action='{{route('dashboard:postAddPosts')}}' enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="title" value="{{old('title')}}" placeholder="@lang('news.hint_title')">
                    {{ $errors->first('title') }}
                </div>
        </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="url" placeholder="@lang('news.hint_url')">
                    {{ $errors->first('url') }}
                    </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" id="new_tags" class="form-control" name="tags" placeholder="@lang('news.hint_tags')">
                    {{ $errors->first('tags') }}
                </div>
